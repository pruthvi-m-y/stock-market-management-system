    ...
    <script>
        ...
        function validateQuantity() {
            ...
            if (quantity > available) {
                alert("You cannot select more than the available quantity (" + available + ").");
...
<body>
    <div class="form-container">
        ...
        <form id="paymentForm" action="payment_action.jsp" method="post">
            ...
            <input type="hidden" id="availableQuantity" name="availableQuantity" value="<%= request.getParameter("availableQuantity") %>">

            <div class="form-group">
                <label for="stockId">Stock ID</label>
                <input type="text" name="stockId" value="<%= request.getParameter("stockId") %>" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="quantity" id="quantity"
                    value="1"
                    min="1"
                    max="<%= request.getParameter("availableQuantity") %>"
